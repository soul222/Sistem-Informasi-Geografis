...
import { autoSubscribe } from '../utils/notification-helper';
...
export default class App {
   ...
   * This runs silently in the background without UI elements
   */
  async #setupAutoNotification() {
    const isLogin = !!getAccessToken();
    
    if (!isLogin) {
      console.log('[App] User not logged in, skipping auto notification setup');
      return;
    }
